...
void ARP_printer(unsigned char *buffer, int buffer_len){
    ...
    arp_header(buffer);
    // print packet payload
    unsigned char *data = (buffer  + sizeof(struct ethhdr) + sizeof(struct arphdr));
    int data_len = buffer_len - (sizeof(struct ethhdr) + sizeof(struct arphdr));
    payload(data, data_len);
    printf("--------------------------------------------------------------\n\n\n");
}
...
void TCP_printer(unsigned char *buffer, int buffer_len){
    ...
    tcp_header(buffer);
    // print packet payload
    unsigned char *data = (buffer  + sizeof(struct ethhdr) + ipheader_len + sizeof(struct tcphdr));
    int data_len = buffer_len - (sizeof(struct ethhdr) + ipheader_len + sizeof(struct tcphdr));
    payload(data, data_len);
    printf("--------------------------------------------------------------\n\n\n");
}
...
void UDP_printer(unsigned char* buffer, int buffer_len){
    ...
    udp_header(buffer);
    // print packet payload
    unsigned char *data = (buffer  + sizeof(struct ethhdr) + ipheader_len + sizeof(struct udphdr));
    int data_len = buffer_len - (sizeof(struct ethhdr) + ipheader_len + sizeof(struct udphdr));
    payload(data, data_len);
    printf("--------------------------------------------------------------\n\n\n");
