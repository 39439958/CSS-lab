...
{
       0,   256,   257,   258,   124,    59,    62,    60,    38,    10
};
# endif
...
{
      -3,     2,    -9,    16,     3,    -9,     2,    -9,    -9,    14,
      14,    14,    14,    -9,    -9,    -9,     7,     7,    10,    10
};
...
#line 1348 "parser.tab.c"
  ...
  case 8:
#line 43 "parser.y"
                                                        { (yyval.cmd) = Cmd_Redir_new((yyvsp[-2].cmd), (yyvsp[0].cmd), 1, 1);}
#line 1354 "parser.tab.c"
    break;

  case 9:
#line 44 "parser.y"
                                                                { (yyval.cmd) = Cmd_Redir_new((yyvsp[-2].cmd), (yyvsp[0].cmd), 1, 2);}
